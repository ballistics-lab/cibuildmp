# `unix` build image for the **musllinux_1_2_aarch64** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `musllinux_1_2_aarch64`, digest-pinned from
...
#          -t musllinux_1_2_aarch64 \
#          -f docker/musllinux_1_2_aarch64.Dockerfile .
# Use:   CIBMP_UNIX_MUSLLINUX_1_2_AARCH64_DOCKER_IMAGE=musllinux_1_2_aarch64 cibuildmp ...
#
...
FROM quay.io/pypa/musllinux_1_2_aarch64@sha256:cea133e28484a93e9c40fc661256e8f1ec69b2887d0b64acbfaf48f26bbab103

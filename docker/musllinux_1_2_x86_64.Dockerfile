# `unix` build image for the **musllinux_1_2_x86_64** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `musllinux_1_2_x86_64`, digest-pinned from
...
#          -t musllinux_1_2_x86_64 \
#          -f docker/musllinux_1_2_x86_64.Dockerfile .
# Use:   CIBMP_UNIX_MUSLLINUX_1_2_X86_64_DOCKER_IMAGE=musllinux_1_2_x86_64 cibuildmp ...
#
...
FROM quay.io/pypa/musllinux_1_2_x86_64@sha256:75327606c7666fc971bd9239c6b220fd205b4bb9563b588075164622609219ca

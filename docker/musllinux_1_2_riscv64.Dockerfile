# `unix` build image for the **musllinux_1_2_riscv64** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `musllinux_1_2_riscv64`, digest-pinned from
...
#          -t musllinux_1_2_riscv64 \
#          -f docker/musllinux_1_2_riscv64.Dockerfile .
# Use:   CIBMP_UNIX_MUSLLINUX_1_2_RISCV64_DOCKER_IMAGE=musllinux_1_2_riscv64 cibuildmp ...
#
...
FROM quay.io/pypa/musllinux_1_2_riscv64@sha256:c81bcd3275ce4372b3ceb59ad132619ffe3e7c591193c2d5f2ed97aba198ec51

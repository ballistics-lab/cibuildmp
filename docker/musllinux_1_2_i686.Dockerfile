# `unix` build image for the **musllinux_1_2_i686** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `musllinux_1_2_i686`, digest-pinned from
...
#          -t musllinux_1_2_i686 \
#          -f docker/musllinux_1_2_i686.Dockerfile .
# Use:   CIBMP_UNIX_MUSLLINUX_1_2_I686_DOCKER_IMAGE=musllinux_1_2_i686 cibuildmp ...
#
...
FROM quay.io/pypa/musllinux_1_2_i686@sha256:8ca1be90979cb290909c1c945573ccdc7114505d66c563567ee6c78927fb215f

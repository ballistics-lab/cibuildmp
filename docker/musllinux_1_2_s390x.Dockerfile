# `unix` build image for the **musllinux_1_2_s390x** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `musllinux_1_2_s390x`, digest-pinned from
...
#          -t musllinux_1_2_s390x \
#          -f docker/musllinux_1_2_s390x.Dockerfile .
# Use:   CIBMP_UNIX_MUSLLINUX_1_2_S390X_DOCKER_IMAGE=musllinux_1_2_s390x cibuildmp ...
#
...
FROM quay.io/pypa/musllinux_1_2_s390x@sha256:97af923ea31a097445fcaad1af154e1f0fd997a6d722141d55607dc3767f8782

# `unix` build image for the **manylinux_2_39_riscv64** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `manylinux_2_39_riscv64`, digest-pinned from
...
# the gcc that targets riscv64, the whole userland -- comes from there.
...
# rather than a label.
#
# **This is a `linux/riscv64` image**, built and published for its own
...
# `exec format error`.
#
# Build: docker buildx build --platform=linux/riscv64 \
#          -t manylinux_2_39_riscv64 \
#          -f docker/manylinux_2_39_riscv64.Dockerfile .
# Use:   CIBMP_UNIX_MANYLINUX_2_39_RISCV64_DOCKER_IMAGE=manylinux_2_39_riscv64 cibuildmp ...
#
...
FROM quay.io/pypa/manylinux_2_39_riscv64@sha256:9fa1bc388ea2494e457eec44e7c16a9e66fff892d73da8af3621009e76167949

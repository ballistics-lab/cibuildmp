# `unix` build image for the **manylinux_2_28_aarch64** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `manylinux_2_28_aarch64`, digest-pinned from
...
# the gcc that targets aarch64, the whole userland -- comes from there.
...
# rather than a label.
#
# **This is a `linux/arm64` image**, built and published for its own
...
#          -t manylinux_2_28_aarch64 \
#          -f docker/manylinux_2_28_aarch64.Dockerfile .
# Use:   CIBMP_UNIX_MANYLINUX_2_28_AARCH64_DOCKER_IMAGE=manylinux_2_28_aarch64 cibuildmp ...
#
...
FROM quay.io/pypa/manylinux_2_28_aarch64@sha256:561427136aabf3787bffb294b3515748241e0962d1527ae28bea1e076bfb9d99
...
# libffi`, and inside a stock `manylinux_2_28_aarch64` that command fails

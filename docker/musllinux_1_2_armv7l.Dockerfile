# `unix` build image for the **musllinux_1_2_armv7l** cell -- one native
# image per (architecture, libc floor), record 0043.
#
# `FROM` is pypa's own `musllinux_1_2_armv7l`, digest-pinned from
...
#          -t musllinux_1_2_armv7l \
#          -f docker/musllinux_1_2_armv7l.Dockerfile .
# Use:   CIBMP_UNIX_MUSLLINUX_1_2_ARMV7L_DOCKER_IMAGE=musllinux_1_2_armv7l cibuildmp ...
#
...
FROM quay.io/pypa/musllinux_1_2_armv7l@sha256:c7ee1ecd4967a3ea682c814b564a900d90dc81d75b0b7c2deeb8d6819752a460
